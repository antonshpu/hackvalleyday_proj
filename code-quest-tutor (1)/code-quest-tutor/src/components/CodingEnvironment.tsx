...
export function CodingEnvironment({ plan }: Props) {
  ...
  function handleResources() {
    window.open('https://developer.mozilla.org/en-US/search?q=' + encodeURIComponent(currentTask?.title ?? ''), '_blank', 'noopener');
  }
  ...
  return (
    <div className="h-full flex flex-col bg-ink-900">
      <TopBar
        ...
        xp={state.xp}
        levelLabel={`Level ${level.index + 1} / ${plan.levels.length}`}
        ...
        <div className="w-[25%] min-w-[260px] flex flex-col gap-3 p-3 overflow-y-auto bg-ink-900">
          ...
          <div className="mt-auto pt-1">
            ...
            <button
              ...
              className="w-full mt-2 text-[10px] font-mono text-parchment-300/40 hover:text-parchment-300/70"
            >
              reset progress
            </button>
          </div>
